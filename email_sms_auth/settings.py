"""
Django settings for email_sms_auth project.
...
SECRET_KEY = 'django-insecure-!s6rfvw1#gs+q(l-3)gux=psy$&2=_t$1rr$-f83e8)@)$(5&u'
...
ROOT_URLCONF = 'email_sms_auth.urls'
...
WSGI_APPLICATION = 'email_sms_auth.wsgi.application'
